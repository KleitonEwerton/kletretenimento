...
<head>
  ...
  <meta charset="utf-8">
  <title>SIDEBAR</title>
  <link rel="stylesheet" href="../../../public/css/sidebarstyles.css" content="width=device-width, initial-scale=1.0">

</head>
<input type="checkbox" id="check">
<label for="check">
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid-3x3-gap-fill" viewBox="0 0 16 16" id="btn">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-x-fill" viewBox="0 0 16 16" id="cancel">
...
<div class="sidebar">
  <header><img src="../../../public/assets/logo3-sem-fundo.png" alt="logo" height="200" width="200"></header>
  <a href="landing-page" class="active">
  ...
  <a href="https://www.linkedin.com/company/codejr">
